...
delete Provincias
go
insert into Provincias(id, nombre) values( 1,'Santiago del Estero')
...
insert into Provincias(id, nombre) values( 21,'Buenos Aires')
insert into Provincias(id, nombre) values( 22,'Tierra del Fuego')
insert into Provincias(id, nombre) values( 23,'Tucumán')
insert into Provincias(id, nombre) values( 24,'Capital Federal')
